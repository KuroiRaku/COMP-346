...
public class Assignment2 {
    ...
    public static void main(String[] args) {
        ...
        //while (TIME_UNIT < 15)
        {
            ...
            ArrayList<Process> temp_Waiting_Queue = new ArrayList<Process>();  
            ...
            for (int i = 0; i < Processes.size(); ++i)
            {
                if (Processes.get(i).getArrivaltime() == TIME_UNIT)
                {
                    ...
                    temp_Processes.add(Processes.get(i));
                }
            }
            ...
            for (int j = 0; j < waiting_queue.size(); ++j)
            {
                ...
                if (waiting_queue.get(j).getIoWaitTime() > 2)
                {
                    ...
                    temp_Waiting_Queue.add(waiting_queue.get(j));
                }
            }
            // removing them from ready_queue
            for (Process p : temp_Waiting_Queue) {
