...
public class Client extends Thread {
    ...
    /* Client object to handle network operations */
    ...
    public void readTransactions() {
        ...
        /* Transactions input file stream */
        int i = 0;
        /* Index of transactions array */

        try {
            inputStream = new Scanner(new FileInputStream("src/javaapplication11/transaction.txt"));
        ...
        /* Record the number of transactions processed */
