...
public class Network extends Thread {
    ...
    /* Network buffer indices for accessing the input buffer (inputIndexClient, outputIndexServer) and output buffer (inputIndexServer, outputIndexClient) */
 ...
 /* Check if output buffer is empty */
    ...
    /**
     * Transferring the completed transactions from the server to the network
     * buffer
     *
     * @return
     * @param outPacket updated transaction transferred by the server to the
 ...
 /* Check if output buffer is full */
     ...
     *
     * @return
     * @param inPacket transaction transferred from the input buffer to the
     * server
     *
     */
