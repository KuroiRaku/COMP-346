...
public class Server extends Thread {
    ...
    /* Number of transactions handled by the server */
    int numberOfAccounts;
    /* Number of accounts stored in the server */
    int maxNbAccounts;
    /* maximum number of transactions */
    Transactions transaction;
    /* Transaction being processed */
    Network objNetwork;
    /* Server object to handle network operations */
    Accounts[] account;

    /* Accounts to be accessed or updated */
    ...
    public void initializeAccounts() {
        ...
        /* accounts input file stream */
        int i = 0;
        /* index of accounts array */

        try {
            inputStream = new Scanner(new FileInputStream("src/javaapplication11/account.txt"));
        ...
        /* Record the number of accounts processed */
    ...
    public boolean processTransactions(Transactions trans) {
        int accIndex;
        /* Index position of account to update */
        double newBalance;
...
//                System.out.println("Problem at in buffer status equals empty in server");
            ...
            if (!objNetwork.getInBufferStatus().equals("empty")) {
                ...
                } else /* Process withdraw operation */ if (trans.getOperationType().equals("WITHDRAW")) {
                    newBalance = withdraw(accIndex, trans.getTransactionAmount());
                    trans.setTransactionBalance(newBalance);
                    trans.setTransactionStatus("done");


                } else /* Process query operation */ if (trans.getOperationType().equals("QUERY")) {
